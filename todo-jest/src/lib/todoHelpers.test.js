import { addTodo , findById, toggleTodo, updateTodo, removeTodo, editTodo } from './todoHelpers'
...
test('editTodo should edit todo from todos by id', () => {
    const startTodos = [
        { id: 1, name: 'one', isComplete: false },
        { id: 2, name: 'two', isComplete: false },
        {id: 3, name: 'three', isComplete: false}
    ...
    const expected = [
        { id: 1, name: 'one', isComplete: false },
        { id: 2, name: edit, isComplete: false },
        {id: 3, name: 'three', isComplete: false}
    ]

    const result = editTodo(startTodos,2,edit)
    expect(result).toEqual(expected)
})
